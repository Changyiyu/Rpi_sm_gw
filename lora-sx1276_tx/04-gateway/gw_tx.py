...
import numpy as np
from smart_meter1 import smart_meter_state1
from smart_meter2 import smart_meter_state2
from smart_meter3 import smart_meter_state3
...
class LoRaBeacon(LoRa):
    ...
    def start(self):
        count = 0
        meters = 3
        rawinput = smart_meter_state1(count)
        #for i in range(3):
            #if(i == 0):
                #rawinput = smart_meter_state1(count)
                #break
            #elif(i == 1):
                #rawinput = smart_meter_state2(count)
                #break
            #elif(i == 2):
                #rawinput = smart_meter_state3(count)
                #break
            #else:
                #
                #print('meter error')
        ...
        while True:
            ...
            if len(rawinput[count]) < 200:
            #if list(rawinput) < 200:  

                data = {"id":self._id, "data":rawinput[count]}
